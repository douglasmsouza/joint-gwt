...
import com.joint.gwt.client.injector.ResourceInjector;
...
public class JointGraph<T extends JointBean<T>> extends Composite implements Iterable<JointMember<T>> {
    ...
    public JointGraph(final JointGraphOptions graphOptions) {
        this(graphOptions, null, getDefaultResources());
    }

    public JointGraph(final JointGraphOptions graphOptions, final T rootMember) {
        this(graphOptions, rootMember, getDefaultResources());
    }

    public JointGraph(final JointGraphOptions graphOptions, final T rootMember, Resources resources) {
